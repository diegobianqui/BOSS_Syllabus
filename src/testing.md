...
## 1. The Philosophy of Testing Consensus
...
## 2. The Functional Test Architecture
...
## 3. The `BitcoinTestFramework` Flow
...
## 4. Manipulating State (The "Test The Test" Mindset)
...
### 4.1 Script and Transaction Forgery
